...
from modules.models.encoder import (
    BaseEncoder,
    TransducerEncoder,
)
...
class EncoderModel(BaseModel):
    """ Super class of modules's Encoder only Models """
    def __init__(self):
...
class EncoderDecoderModel(BaseModel):
    """ Super class of modules's Encoder-Decoder Models """
...
class TransducerModel(BaseModel):
    """ Super class of modules's Transducer Models """
    def __init__(
            self,
