...
from modules.models.convolution import DeepSpeech2Extractor, VGGExtractor
...
class BaseEncoder(EncoderInterface):
    """ ASR Encoder Super Class for modules model implementation """
...
class TransducerEncoder(EncoderInterface):
    """ ASR Transducer Encoder Super class for modules model implementation """
    def __init__(self):
