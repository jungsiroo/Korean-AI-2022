...
from modules.data import AudioDataLoader
from modules.decode.search import (
    GreedySearch,
    BeamSearch
)
...
class Evaluator(object):
    ...
    Args:
        dataset (modules.data.data_loader.SpectrogramDataset): dataset for spectrogram & script matching
