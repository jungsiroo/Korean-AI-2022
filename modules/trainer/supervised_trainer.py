...
from modules.metrics import CharacterErrorRate
...
class SupervisedTrainer(object):
    ...
    Args:
        optimizer (modules.optim.__init__.Optimizer): optimizer for training
        criterion (torch.nn.Module): loss function
        trainset_list (list): list of training datset
        validset (modules.data.data_loader.SpectrogramDataset): validation dataset
